...
RobotPathMove.prototype.initialize = function () {
    ...
    this.path = [
        ...
        { showMessage: '去拿料', turn: '', position: { x: 1.7, y: 0, z: 1.336 }, lookAt: { x: 1.7, y: 0, z: 1.7 } },
        { showMessage: '去拿料', turn: '', position: { x: 1.7, y: 0, z: 2.5 }, lookAt: { x: 1.7, y: 0, z: 2.6 } },
        { showMessage: '去拿料', turn: '', position: { x: 1.7, y: 0, z: 4.5 }, lookAt: { x: 1.7, y: 0, z: 4.6 } },
        ...
        { showMessage: '加工中', turn: '', position: { x: 0.4, y: 0, z: -0.9 }, lookAt: { x: 0.4, y: 0, z: -1.3 } },
        { showMessage: '加工中', turn: 'pause', position: { x: 0.4, y: 0, z: -0.9 }, lookAt: { x: 0.4, y: 0, z: -1.3 } },
        { showMessage: '加工中', turn: 'take', position: { x: 0.4, y: 0, z: -0.9 }, lookAt: { x: 0.4, y: 0, z: -1.3 } },
        ...
        { showMessage: '去加工', turn: '', position: { x: 0.2, y: 0, z: -3.5 }, lookAt: { x: 0.3, y: 0, z: -0.9 } },
        { showMessage: '去加工', turn: '', position: { x: 0.2, y: 0, z: -0.9 }, lookAt: { x: 0.3, y: 0, z: -0.9 } },
        { showMessage: '加工中', turn: '', position: { x: 0.2, y: 0, z: -0.9 }, lookAt: { x: -2, y: 0, z: -0.9 } },
        { showMessage: '加工中', turn: 'pause', position: { x: 0.2, y: 0, z: -0.9 }, lookAt: { x: -2, y: 0, z: -0.9 } },
        { showMessage: '去检测', turn: '', position: { x: 0.2, y: 0, z: -0.9 }, lookAt: { x: 0.3, y: 0, z: -0.9 } },
